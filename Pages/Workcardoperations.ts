...
export class Locators {
    ...
    constructor(page: Page) {
        ...
        this.beginApplication = page.getByText('Begin', { exact: true });
        this.continueButton = page.getByText('Continue', { exact: true });
        this.viewProgramDetails = page.getByText('View Program Details', { exact: true });
        ...
        this.textAreaForAnimals = page.locator('label:has-text("Essay about Animals") + textarea[placeholder="Long Input"]');
    ...
    async programDetails() {
        await this.viewProgramDetails.click();
    }
